...
class ProductRepository extends Repository
{
    ...
    public static function storeByRequest(ProductRequest $request): Product
    {
        ...
        $product = self::create([
            ...
            'processing_available' => (bool) $request->processing_available,
            'raw_price' => $request->raw_price ?? $request->price,
            'processed_price' => $request->processing_available ? $request->processed_price : null,
    ...
    private static function storeBulkProduct($data)
    {
        ...
        $product = self::create([
            ...
            'raw_price' => $data['price'] ?? 0,
            'processed_price' => null,
